...
export class DishAddComponent implements OnInit {
  ...
  dishAddForm = new FormGroup({
    ...
    dishtype: new FormControl('', [Validators.required, Validators.minLength(2)]),
    dishcategory: new FormControl('', [Validators.required, Validators.minLength(2)]),
    dishingredients: new FormControl('', [Validators.required, Validators.minLength(2)]),
    dishmaxperday: new FormControl('', [Validators.required, Validators.min(1), Validators.pattern("[0-9]*")]),
    dishprice: new FormControl('', [Validators.required, Validators.min(1), Validators.pattern("[0-9]*\.?[0-9]+")]),
    dishshortdesc: new FormControl('', [Validators.required, Validators.minLength(2)]),
    dishimagelink: new FormControl('', [Validators.required, Validators.minLength(2)]),
  });
